...
delete from dog where weightKg=13;

delete from dog where lenght=50;

delete from dog where weightKg=5;

delete from dog where weightKg=1;

delete from dog where lenght=35;
